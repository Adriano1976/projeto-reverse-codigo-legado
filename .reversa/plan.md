# Plano de Exploração — projeto-python-biblia
...
- [✅] **Archaeologist** — Análise do módulo `quiz_engine` (Lógica e GUI)
- [✅] **Archaeologist** — Análise do módulo `question_bank` (Banco de perguntas)
