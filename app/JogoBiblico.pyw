...
class Packing:
    def __init__(self, instancia):
        ...
        Button(self.container0, width=72, height=4, text='Você está pensando que conhece a Bíblia? \
...
e respostas sobre o Livro mais conhecido\n e respeitado de todos os tempos.',
        ...
        Button(self.container1, width=18, height=2, text='Provérbios 28:13', font='Verdana', bg='FireBrick', fg='white',
               command=proverbios_2813).pack(side=RIGHT)
        Button(self.container1, width=18, height=2, text='Daniel 1:1-6', font='Verdana', bg='FireBrick', fg='white',
               command=daniel_116).pack(side=RIGHT)
        Button(self.container1, width=18, height=2, text='Provérbios 15:1', font='Verdana', bg='FireBrick', fg='white',
               command=proverbios_151).pack(side=RIGHT)
        Button(self.container1, width=18, height=2, text='Atos 18:2', font='Verdana', bg='FireBrick', fg='white',
               command=atos_182).pack(side=RIGHT)
        Button(self.container1, width=18, height=2, text='Gênesis 4:1-25', font='Verdana', bg='FireBrick', fg='white',
               command=geneses_4125).pack(side=RIGHT)
        Button(self.container2, width=18, height=2, text='Tiago 5:14', font='Verdana', bg='FireBrick', fg='white',
               command=tiago_514).pack(side=LEFT)
        Button(self.container2, width=18, height=2, text='Romanos 6:3-6', font='Verdana', bg='FireBrick', fg='white',
               command=romanos_636).pack(side=LEFT)
        Button(self.container2, width=18, height=2, text='João 1:48', font='Verdana', bg='FireBrick', fg='white',
               command=joao_148).pack(side=LEFT)
        Button(self.container2, width=18, height=2, text='Lucas 3:23', font='Verdana', bg='FireBrick', fg='white',
               command=lucas_323).pack(side=LEFT)
        Button(self.container2, width=18, height=2, text='Efésios 2:19-20', font='Verdana', bg='FireBrick', fg='white',
               command=efesios_21920).pack(side=LEFT)

        self.b4 = Button(self.container3, width=18, height=2, text='Mateus 4:3-4', font='Verdana', bg='FireBrick',
                         fg='white',
                         command=mateus_434)
        self.b41 = Button(self.container3, width=18, height=2, text='I Pedro 1:19-20', font='Verdana', bg='FireBrick',
                          fg='white',
                          command=Ipedro_11920)
        self.b5 = Button(self.container3, width=18, height=2, text='Hebreus 11:1-3', font='Verdana', bg='FireBrick',
                         fg='white',
                         command=hebreus_1113)
        self.b6 = Button(self.container3, width=18, height=2, text='I Samuel 17:49-50', font='Verdana', bg='FireBrick',
                         fg='white',
                         command=Isamuel_174950)
        self.b7 = Button(self.container3, width=18, height=2, text='João 4:6-7', font='Verdana', bg='FireBrick',
                         fg='white',
                         command=joao_467)
        self.b8 = Button(self.container4, width=18, height=2, text='Êxodo 16:3', font='Verdana', bg='FireBrick',
                         fg='white',
                         command=exodo_163)
        self.b81 = Button(self.container4, width=18, height=2, text='Tiago 1:5-6', font='Verdana', bg='FireBrick',
                          fg='white',
                          command=tiago_156)
        self.b9 = Button(self.container4, width=18, height=2, text='Isaias 1:18', font='Verdana', bg='FireBrick',
                         fg='white',
                         command=isaias_118)
        self.b10 = Button(self.container4, width=18, height=2, text='Marcos 10:46-52', font='Verdana', bg='FireBrick',
                          fg='white',
                          command=marcos_104652)
        self.b11 = Button(self.container4, width=18, height=2, text='Mateus 4:18-19', font='Verdana', bg='FireBrick',
                          fg='white',
                          command=mateus_41819)
        self.b12 = Button(self.container5, width=18, height=2, text='Josué 6:1-20', font='Verdana', bg='FireBrick',
                          fg='white',
                          command=josue_6120)
        self.b121 = Button(self.container5, width=18, height=2, text='Lucas 17:11-19', font='Verdana', bg='FireBrick',
                           fg='white',
                           command=lucas_171119)
        self.b13 = Button(self.container5, width=18, height=2, text='João 12:12-13', font='Verdana', bg='FireBrick',
                          fg='white',
                          command=joao_121213)
        self.b14 = Button(self.container5, width=18, height=2, text='I Coríntios 2:14', font='Verdana', bg='FireBrick',
                          fg='white',
                          command=Icorintios_214)
        self.b15 = Button(self.container5, width=18, height=2, text='Lucas 19:45-48', font='Verdana', bg='FireBrick',
                          fg='white',
                          command=lucas_194548)
        self.b16 = Button(self.container6, width=18, height=2, text='João 18:31', font='Verdana', bg='FireBrick',
                          fg='white',
                          command=joao_1831)
        self.b161 = Button(self.container6, width=18, height=2, text='Gênesis 48:13-14', font='Verdana', bg='FireBrick',
                           fg='white',
                           command=genesis_481314)
        self.b17 = Button(self.container6, width=18, height=2, text='Mateus 26:63', font='Verdana', bg='FireBrick',
                          fg='white',
                          command=mateus_2663)
        self.b18 = Button(self.container6, width=18, height=2, text='João 19:32', font='Verdana', bg='FireBrick',
                          fg='white',
                          command=joao_1932)
        self.b19 = Button(self.container6, width=18, height=2, text='Atos 13:1-3', font='Verdana', bg='FireBrick',
                          fg='white',
                          command=atos_1313)
        self.b20 = Button(self.container7, width=18, height=2, text='Mateus 27:30', font='Verdana', bg='FireBrick',
                          fg='white',
                          command=mateus_2730)
        self.b201 = Button(self.container7, width=18, height=2, text='I Reis 17:10-11', font='Verdana', bg='FireBrick',
                           fg='white',
                           command=Ireis_171011)
        self.b21 = Button(self.container7, width=18, height=2, text='Gêneses 25:33', font='Verdana', bg='FireBrick',
                          fg='white',
                          command=geneses_2533)
        self.b22 = Button(self.container7, width=18, height=2, text='Josué 24:32', font='Verdana', bg='FireBrick',
                          fg='white',
                          command=josue_2432)
        self.b23 = Button(self.container7, width=18, height=2, text='Provérbios 23:20-21', font='Verdana',
                          bg='FireBrick', fg='white',
                          command=proverbios_232021)
        self.b24 = Button(self.container8, width=18, height=2, text='João 12:4-5', font='Verdana', bg='FireBrick',
                          fg='white',
                          command=joao_1245)
        self.b241 = Button(self.container8, width=18, height=2, text='Neemias 8:3,9', font='Verdana', bg='FireBrick',
                           fg='white',
                           command=neemias_839)
        self.b25 = Button(self.container8, width=18, height=2, text='Apocalipse 14:6-7', font='Verdana', bg='FireBrick',
                          fg='white',
                          command=apocalipse_27)
        self.b26 = Button(self.container8, width=18, height=2, text='Isaias 2:2-3', font='Verdana', bg='FireBrick',
                          fg='white',
                          command=isaias_223)
        self.b27 = Button(self.container8, width=18, height=2, text='Apocalípse 20:13', font='Verdana', bg='FireBrick',
                          fg='white',
                          command=apocalipse_2013)
        self.b28 = Button(self.container9, width=18, height=2, text='Malaquias 3:8-12', font='Verdana', bg='FireBrick',
                          fg='white',
                          command=malaquias_3812)
        self.b281 = Button(self.container9, width=18, height=2, text='Amós 3:7', font='Verdana', bg='FireBrick',
                           fg='white',
                           command=amos_37)
        self.b29 = Button(self.container9, width=18, height=2, text='I Timóteo 4:1-3', font='Verdana', bg='FireBrick',
                          fg='white',
                          command=Itimoteo_413)
        self.b30 = Button(self.container9, width=18, height=2, text='Joel 2:28-32', font='Verdana', bg='FireBrick',
                          fg='white',
                          command=joel_22832)
        self.b31 = Button(self.container9, width=18, height=2, text='Malaquias 4:5-6', font='Verdana', bg='FireBrick',
                          fg='white',
...
janela.geometry('980x590+100+70')
menubar = Menu(janela)
...
def donothing():
    filewin = Toplevel(janela)
    janela.geometry('980x750+100+70')
    lb0 = Label(filewin,
                text='==============================================================\nMomentos de Buscar Sabedoria e '
                     'Refletir.\n==============================================================',
    ...
    lb1 = Label(filewin, text='O Evangelho Está Funcionando para Você?', font=('times', 18, 'italic'), bg='white',
                width=80, height=2)
    lb2 = Label(filewin, text='Comece de Onde Está, Seja humilde sempre.', font=('times', 18, 'italic'), bg='yellow',
                width=80, height=2)
    lb3 = Label(filewin, text='Você É Digno de Ser Resgatado Pelo Senhor', font=('times', 18, 'italic'), bg='blue',
                fg='white', width=80, height=2)
    lb4 = Label(filewin, text='Precisamos Reservar Tempo Para Exercer A Fé.', font=('times', 18, 'italic'), bg='green',
                width=80, height=2)
    lb5 = Label(filewin, text='Não Deixe Que Nada Nem Ninguém O Impeça De Ser Vitorioso.', font=('times', 18, 'italic'),
                bg='DarkKhaki', width=80, height=2)
    lb6 = Label(filewin, text='A Oração Em Família Deve Ser Uma Prioridade Inadiável De Sua Vida Diária.',
                font=('times', 18, 'italic'), bg='Maroon', fg='white', width=80, height=2)
    lb7 = Label(filewin, text='“Rejeitar o mal e escolher o bem” (Isaías 7:15).', font=('times', 18, 'italic'),
                bg='Thistle', width=80, height=2)
    lb8 = Label(filewin, text='É importante erguer-nos acima das racionalizações e fazer as melhores escolhas.',
                font=('times', 18, 'italic'), bg='Lime', width=80, height=2)
    lb9 = Label(filewin, text='Quando racionalizamos as escolhas erradas, perdemos as bênçãos que necessitamos.',
                font=('times', 18, 'italic'), bg='SlateGray', width=80, height=2)
    lb10 = Label(filewin,
                 text='A imensidão do universo não mudou de repente, mas nossa \ncapacidade de ver e entender essa '
                      'verdade mudou drasticamente.',
                 font=('times', 18, 'italic'), bg='SteelBlue', width=80, height=2)
    lb11 = Label(filewin,
                 text='Nosso conhecimento prévio pode até parecer tolice para nós porque o que \nantes era tão claro '
                      'novamente se tornou borrado, embaçado e distante.',
                 fg='white', font=('times', 18, 'italic'), bg='Navy', width=80, height=2)
    lb12 = Label(filewin,
                 text='Acaso não temos motivo para encher-nos de gratidão, \nsejam quais forem as circunstâncias em '
                      'que nos encontremos?',
                 font=('times', 18, 'italic'), bg='#00FFFF', width=80, height=2)
    lb13 = Label(filewin,
                 text='E aquele que receber todas as coisas com gratidão será glorificado; e as coisas desta Terra '
                      '\nser-lhe-ão acrescentadas, mesmo centuplicadas, sim, mais',
                 font=('times', 18, 'italic'), bg='SkyBlue', width=80, height=2)
